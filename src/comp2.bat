...
tcc -w- -O -c -ml -I..\pdpclib memmgr.c format.c patmat.c
tcc -w- -O -c -ml -I..\pdpclib bos.c fat.c ..\pdpclib\string.c ..\pdpclib\ctype.c ..\pdpclib\dossupc.c
rem bcc -w- to switch off warnings
tcc -w- -O -j1 -c -ml -I..\pdpclib pdos.c 
