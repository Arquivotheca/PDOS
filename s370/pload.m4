...
//*
//GCC      EXEC PGM=GCC,
// PARM='-E -S -remap -DHAVE_CONFIG_H -DIN_GCC -DPUREISO -o dd:out -'
//STEPLIB  DD  DSN=GCC.LINKLIB,DISP=SHR
//SYSIN    DD  DSN=GCC.SOURCE(C@COMMON),DISP=SHR
//SYSPRINT DD  SYSOUT=*
//SYSTERM  DD  SYSOUT=*
//*OUT      DD  SYSOUT=*
//INCLUDE  DD  DSN=GCC.INCLUDE,DISP=SHR,DCB=BLKSIZE=32760
//         DD  DSN=PDPCLIB.INCLUDE,DISP=SHR
//SYSINCL  DD  DSN=GCC.INCLUDE,DISP=SHR,DCB=BLKSIZE=32760
//         DD  DSN=PDPCLIB.INCLUDE,DISP=SHR
