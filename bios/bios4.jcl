...
//         PEND
//*
//UNZIP2   PROC IN=,OUT=,MINPREF='MINIZIP',BIOPREF='BIOS'
//MINI     EXEC PGM=MINIUNZ,PARM='-a dd:input dd:output'
//STEPLIB  DD DSN=&MINPREF..LINKLIB,DISP=SHR
//INPUT    DD DSN=&&ZIPS(&IN),DISP=(OLD,PASS)
//OUTPUT   DD DSN=&BIOPREF..&OUT,DISP=SHR
//SYSIN    DD DUMMY
//SYSPRINT DD SYSOUT=*
//SYSTERM  DD SYSOUT=*
//         PEND
//*
//S1 EXEC UNZIP1
//S2 EXEC UNZIP2,IN='BIOSSRC',OUT='SOURCE'
//S3 EXEC UNZIP2,IN='BIOSINC',OUT='INCLUDE'
//S4 EXEC UNZIP2,IN='BIOSJCL',OUT='JCL'
//
