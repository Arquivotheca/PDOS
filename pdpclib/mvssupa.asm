...
*MVSJFCB SLR   R6,R6              FOR AM31                      GP14205
...
*
         GETMAIN RC,LV=ZDCBLEN,SP=SUBPOOL,LOC=BELOW,BNDRY=PAGE **DEBUG
*DEBUG*  GETMAIN RU,LV=ZDCBLEN,SP=SUBPOOL,LOC=BELOW  I/O work area BTL
...
*CALLER* GAM24 ,                  Get low on S380               GP17079
