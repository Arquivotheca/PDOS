...
gcc -shared -s -nostdlib -o msvcrt.dll -Wl,--kill-at stdio.o string.o stdlib.o start.o time.o errno.o assert.o signal.o locale.o ctype.o setjmp.o math.o winsupa.obj -lkernel32
