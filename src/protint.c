...
static struct {
  ...
  { 0xffff, 0x0, 0x00, 0xfa /* ring 3 code */, 0xcf, 0x00 },
  { 0xffff, 0x0, 0xff, 0xf2 /* ring 3 data */, 0xcf, 0xff },
  {0} /* Space for Task State Segment entry. */
};
...
descptr gdtinfo = { sizeof(descriptors) - 1 };
