...
tcc -w- -O -c -ml -j1 -I..\pdpclib memmgr.c format.c patmat.c process.c helper.c
...
tlink -x pdosstrt+pdos+bos+support+fat+dossupa+string+dossupc+lldos+handlers+memmgr+format+ctype+patmat+process+helper,pdos.exe
