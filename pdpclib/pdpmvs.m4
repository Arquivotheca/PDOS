...
// SPACE=(CYL,(1,1,20)),UNIT=SYSALLDA
//DD15     DD DSN=&&CMDLIB,DISP=(,PASS),
// DCB=(RECFM=FB,LRECL=80,BLKSIZE=3120),
// SPACE=(CYL,(1,1,20)),UNIT=SYSALLDA
//*
//TSTCMD   EXEC PGM=IEBGENER
//SYSUT2   DD  DSN=&&CMDLIB(TSTCMD),DISP=(OLD,PASS)
//SYSUT1   DD  *
PROC 0
SET SYSOUTTRAP=50
PDPTEST aBc DeF
Greetings from CLIST
SET SYSOUTTRAP=0
WRITE LINE 1 is &SYSOUTLINE1
WRITE LINE 2 is &SYSOUTLINE2
WRITE LINE 3 is &SYSOUTLINE3
WRITE HI PDPTEST aBc DeF
/*
//SYSPRINT DD  SYSOUT=*
//SYSIN    DD  DUMMY
//*
...
/*
//*
//BATCH    EXEC PGM=IKJEFT01,DYNAMNBR=60
//STEPLIB  DD  DSN=&&LOADLIB,DISP=(OLD,PASS)
//SYSTSPRT DD  SYSOUT=*
//SYSTSIN  DD  *
TSTCMD
Greetings from SYSTSIN
/*
//SYSPRINT DD  SYSOUT=*
//SYSTERM  DD  SYSOUT=*
//SYSABEND DD  SYSOUT=*
...
Uh oh, SYSIN
/*
//SYSPROC  DD  DSN=&&CMDLIB,DISP=(OLD,PASS)
//
