...
// COS2='-DXXX_MEMMGR -o dd:out -',LPARM='NCAL'
//*
//COMP     EXEC PGM=GCC,
// PARM='&COS1 &COS2'
...
//*
//LKED     EXEC PGM=IEWL,PARM='AMODE=31,RMODE=ANY,&LPARM',
...
//SYSIN    DD DSN=&PDPPREF..SOURCE(&MEMBER),DISP=SHR
//*
//LKED     EXEC PGM=IEWL,PARM='AMODE=31,RMODE=ANY,NCAL',
//            COND=(4,LT,ASM)
//SYSLIN   DD DSN=&&OBJSET,DISP=(OLD,DELETE)
//         DD DDNAME=SYSIN
//SYSIN    DD DUMMY
...
/*
//*
//PDPTEST  EXEC PDPCMP,MEMBER=PDPTEST,LPARM=''
//LKED.SYSLMOD  DD DSN=PDPCLIB.LINKLIB(PDPTEST),DISP=SHR
//LKED.SYSLIB   DD DSN=PDPCLIB.NCALIB,DISP=SHR
//*
//HEXDUMP  EXEC PDPCMP,MEMBER=HEXDUMP,LPARM=''
//LKED.SYSLMOD  DD DSN=PDPCLIB.LINKLIB(HEXDUMP),DISP=SHR
//LKED.SYSLIB   DD DSN=PDPCLIB.NCALIB,DISP=SHR
//*
//
