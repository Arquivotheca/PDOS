...
/*********************************************************************/
/*                                                                   */
/*  cmsunzip - unzip files for use by pdpclib                        */
/*  e.g. cmsunzip pdpclib.zip                                        */
/*                                                                   */
/*********************************************************************/
...
int main(int argc, char **argv)
{
    ...
    if (argc <= 1)
    {
        printf("usage: cmsunzip <infile>\n");
        printf("where infile is a sequential file\n");
        printf("e.g. cmsunzip dd:input\n");
        return (0);
    }
/*  outn = *(argv+2); */
