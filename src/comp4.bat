...
bcc -O -mt -c -DPDOS32 -I..\pdpclib pload.c protint.c file.c
bcc -O -mt -c -DNEED_DUMP -DPDOS32 -I..\pdpclib fat.c bos.c pdosload.c ..\pdpclib\string.c ..\pdpclib\dossupc.c
