...
tcc -O -ml -c -I..\pdpclib memmgr.c format.c patmat.c
tcc -O -ml -c -I..\pdpclib bos.c fat.c ..\pdpclib\string.c ..\pdpclib\ctype.c ..\pdpclib\dossupc.c
rem bcc -w- to switch off warnings
tcc -O -j1 -ml -c -I..\pdpclib pdos.c 
