...
gcc -shared -s -nostdlib -o msvcrt.dll dllcrt.o stdio.o string.o stdlib.o start.o time.o errno.o assert.o signal.o locale.o ctype.o math.o winsupa.obj -lkernel32 -L ../src
dlltool -D msvcrt.dll stdio.o string.o stdlib.o start.o time.o errno.o assert.o signal.o locale.o ctype.o math.o -l libmsvcrt.a
